...
func (p *jsiiProxy_PolicyTemplate) validateApplyCrossStackReferenceStrengthParameters(strength awscdk.ReferenceStrength) error {
	if strength == "" {
...
func validatePolicyTemplate_FromPolicyTemplateIdParameters(scope constructs.Construct, id *string, policyTemplateId *string) error {
	...
	if policyTemplateId == nil {
		return fmt.Errorf("parameter policyTemplateId is required, but nil was provided")
	}
